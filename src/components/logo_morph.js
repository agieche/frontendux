...
class LogoMorph extends React.Component {
  ...
  constructor(props) {
    ...
    this.logoAnimationSvgBack = null;
  ...
  handleEnter() {
    this.timeLine
      .to(this.logoAnimationStep1, 1, {rotation: '+=90', scale: 0.8, x: '-=80', ease: Elastic.easeOut})
      .to(this.logoAnimationStep1, 0.3, {morphSVG:{scale: 1, shape:this.logoAnimationBack, ease: Elastic.easeOut}, ease: Bounce.ease}, '-=1')
  }

  handleLeave() {
    this.timeLine
      .to(this.logoAnimationStep1, 1, {rotation: '-=90', scale: 1, x: '+=80', fill: "#00df7a", scale: 0.8, ease: Elastic.easeOut.config(1, 0.3)})
      .to(this.logoAnimationStep1, 0.3, {morphSVG:{shape:this.logoAnimationStep5, ease: Elastic.easeOut}}, '-=1')
    ...
    return (
      <div className={`header__logo morph-logo`}>
        ...
        <div className='morph-logo__hidden-wrapper'>
          ...
          <svg ref={svg => this.logoAnimationSvgBack = svg} id='logo-animation-svg-back' className='morph-logo__target' width="400px" height="230px" viewBox="0 0 400 230" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
              <title>Back</title>
              <desc>Created with Sketch.</desc>
              <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                  <g id="back">
                      <path ref={path => this.logoAnimationBack = path} id='logo-animation-back' transform="translate(115.316527, 115.000000) rotate(90.000000) translate(-115.316527, -115.000000) " d="M115.487506 228.046758 230.316527 2.38847327 189.722082 1.95324193 114.074227 146.955228 41.2987693 3.00803456 0.31652689 2.74993702z" id="path1-copy-10" fill="#00df7a"></path>
                  </g>
              </g>
          </svg>
        </div>
